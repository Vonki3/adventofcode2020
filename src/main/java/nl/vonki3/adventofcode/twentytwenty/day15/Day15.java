...
public class Day15 {
    ...
    public static void main(final String[] args) throws IOException {
        List<Integer> input = Day15.read("src/main/resources/input-day-15.txt");
        long part1 = Day15.part1(input);

        System.out.println("\nDay 15-1:");
        System.out.println("solution = " + part1);

        input = Day15.read("src/main/resources/input-day-15.txt");
        long part2 = Day15.part2(input);
        System.out.println("\nDay 15-2:");
